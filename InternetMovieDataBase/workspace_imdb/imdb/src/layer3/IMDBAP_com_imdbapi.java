...
public class IMDBAP_com_imdbapi extends IMDBAPIAbstract {
	...
	@Override
	public Entry constructEntry (Entry inEntry, String inScrapedString) throws Exception {
		if (inScrapedString.contains("{\"Response\":\"Parse Error\"}")) {
			throw new Exception ("ParseError: " + inEntry.toString());
		}
